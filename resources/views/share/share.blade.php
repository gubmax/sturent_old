...
@section('color-bg')
	<div id="main__color-bg"></div>
@endsection

@section('main-header')
	<h1 class="page-title">Подселение</h1>
@endsection

@section('content')
	<masonry-filters class="form-group" location="{{ $location->value }}" :map-link="true" v-cloak>
	...
	<masonry url={{ "/api/share?".Request::getQueryString() }}
		page="share"
